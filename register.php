...
<body class="hold-transition login-page" style="font-family: 'Quicksand', sans-serif;">
    <div class="login-box">
        ...
        <div class="login-box-body" style="border-radius: 10px;">
            ...
            <p style="text-align: center; font-size: 13px;">Hak Cipta &copy; <?= date('Y'); ?> .<?= $row1['nama_app']; ?> by Kanaan.</p>
<br><center><p>Publish by <a href='https://github.com/tianreformis' title='Kristian Reformis' target='_blank'>Kristian Reformis</a></p></center>
